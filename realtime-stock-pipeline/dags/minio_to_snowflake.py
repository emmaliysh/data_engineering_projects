...
try:
    ...
    if not hasattr(structlog.dev, "Styles"):
        class _DummyStyles:
            pass
        structlog.dev.Styles = _DummyStyles
...
LOCAL_DIR = "Desktop/store"  # use absolute path for Airflow

SNOWFLAKE_USER = "yushanl9"
SNOWFLAKE_PASSWORD = "Snowflake2025!"
SNOWFLAKE_ACCOUNT = "jc12397.us-east-2.aws"
